...
import 'package:instagram_flutter/models/comments.dart';
...
class FirestoreMethods {
  ...
  Future<void> likeCmt( String uid, List likes, String commentId) async {
    try {
      if(likes.contains(uid)) {
        await _firestore
            .collection('comment').doc(commentId).update({
